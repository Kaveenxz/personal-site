...
export default function PortfolioPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-100 text-gray-900 relative"
            ...
            >
                <h1 className="text-6xl mb-4 font-bold bg-gradient-to-r from-black to-gray-600 text-transparent bg-clip-text drop-shadow-lg">
                ...
                <motion.p 
                    ...
                    className="mt-4 text-xl opacity-80 max-w-2xl"
                >
                ...
                <motion.button
                    ...
                    whileTap={{ scale: 0.9 }}
                    className="mt-6 bg-gray-800 text-white px-8 py-4 rounded-full text-lg shadow-md hover:bg-white hover:border-2 hover:border-gray-800 hover:text-gray-800 hover:font-semibold"
                >
                    View Our Work
                </motion.button>
            </motion.div>
            ...
            <div className="bg-white w-full">
                ...
                <div className="max-w-6xl mx-auto py-16 px-6">
                    <h2 className="text-4xl font-bold text-center">Our Latest Projects</h2>
                    ...
                    <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                        {projects.map((project, index) => (
                            <motion.div 
                                ...
                                viewport={{ once: true }}
                                className="relative bg-white shadow-xl rounded-xl overflow-hidden transform hover:scale-105 transition duration-300 group"
                            >
                                <Image src={project.image} alt={project.title} className="w-full h-60 object-cover" />
                                <div className="absolute inset-0 bg-black bg-opacity-40 opacity-0 group-hover:opacity-100 transition duration-300 flex flex-col items-center justify-center">
                                ...
                                <div className="p-6 text-center">
                                    ...
                                    <span className="mt-3 inline-block bg-gray-800 text-white text-sm px-3 py-1 rounded-full">
                                        {project.category}
                                    </span>
                                </div>
                            </motion.div>
            ...
            {/* Call to Action */}
            <div className="w-full bg-gray-100 text-center py-16 text-gray-800"
             style={{
                backgroundImage: "radial-gradient(circle, rgba(0,0,0,0.1) 1px, transparent 1px)",
                backgroundSize: "10px 10px"
            }}>
                <h2 className="text-3xl font-bold">Want to Build Something Stunning?</h2>
                <p className="mt-4 text-lg opacity-80">Let’s turn your ideas into reality with expert design & development.</p>
                <motion.button
                    whileHover={{ scale: 1.1 }}
                    whileTap={{ scale: 0.9 }}
