    ...
    return (
        <div className="min-h-screen bg-gray-100 text-gray-900 dark:bg-gray-900 dark:text-white"
            ...
            <motion.div
                ...
                className="relative w-full h-[50vh] md:h-[500px] flex items-center justify-center text-center px-4 sm:px-6"
            >
                <div className="max-w-4xl mx-auto md:mt-20 max-sm:pt-24">
                    <motion.h1
                        className="text-4xl sm:text-5xl md:text-6xl mb-4 font-bold bg-gradient-to-r from-black dark:from-white dark:to-gray-300 to-gray-400 text-transparent bg-clip-text drop-shadow-lg"
                    ...
                    <motion.h1
                        className="text-4xl sm:text-5xl md:text-6xl font-bold bg-gradient-to-r from-black to-gray-400 dark:from-white dark:to-gray-300 text-transparent bg-clip-text drop-shadow-lg"
                        initial={{ opacity: 0, y: -20 }}
                        animate={{ opacity: 1, y: 0 }}
                    ...
                    <motion.p
                        className="mt-6 text-lg sm:text-xl max-sm:text-sm opacity-80 mx-4 sm:mx-20 dark:text-gray-200"
            ...
            >
                ...
                <div className="max-w-6xl mx-auto py-12 md:py-16 px-4 sm:px-6">
                    <motion.h2
                        className="text-3xl sm:text-4xl md:text-5xl my-6 sm:my-10 font-semibold text-center bg-gradient-to-r from-black to-gray-400 dark:from-white dark:to-gray-300 text-transparent bg-clip-text drop-shadow-lg"
                    ...
                    <motion.p
                        className="mt-4 mb-12 sm:mb-20 text-center text-gray-700 dark:text-gray-200 text-lg sm:text-xl"
                        initial={{ opacity: 0 }}
                        whileInView={{ opacity: 1 }}
                        transition={{ delay: 0.3 }}
                    >
            ...
            <motion.div
                ...
                whileInView={{ opacity: 1 }}
                transition={{ duration: 1 }}
                className="w-full bg-white dark:bg-gray-800 py-12 md:py-16 px-4 sm:px-6"
            >
                <div className="max-w-6xl mx-auto">
                    <h2 className="text-3xl sm:text-4xl md:text-5xl font-semibold text-center bg-gradient-to-r from-black to-gray-400 dark:from-white dark:to-gray-300 text-transparent bg-clip-text drop-shadow-lg">What Makes Us Different?</h2>
                    <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            ...
            <motion.div
                ...
                whileInView={{ opacity: 1 }}
                transition={{ duration: 1 }}
                className="w-full bg-gray-100 dark:bg-gray-900 text-center py-12 md:py-16 text-gray-800"
                style={{
                    backgroundImage: "radial-gradient(circle, rgba(0,0,0,0.1) 1px, transparent 1px)",
                    backgroundSize: "10px 10px"
                }}
            >
                ...
                <motion.button
                    ...
                    whileTap={{ scale: 0.9 }}
                    className="mt-5 bg-gray-800 dark:bg-gray-100 px-6 sm:px-8 py-3 sm:py-4 rounded-full text-white dark:text-gray-900 cursor-pointer transition-all duration-300 hover:bg-white dark:hover:bg-gray-800 hover:border-2 hover:border-gray-800 dark:hover:text-white dark:hover:border-white hover:text-gray-800 hover:font-semibold dark:font-semibold shadow-md"
                >
            ...
            <motion.div
                ...
                className="w-full"
            >
                <hr className="mx-4 sm:mx-20 dark:border dark:border-gray-300" />
            </motion.div>
            <Footer />
        </div>
    );
...
function Card({ title, description }:any) {
    return (
        <motion.div
            ...
            transition={{ duration: 0.6 }}
            className="bg-white dark:bg-gray-900 dark:border-gray-800 shadow-xl rounded-xl p-4 sm:p-6 text-center border border-gray-200 hover:shadow-2xl transition-all"
        >
            <h3 className="text-lg sm:text-xl font-semibold dark:text-white">{title}</h3>
            <p className="mt-2 text-sm sm:text-base text-gray-600 dark:text-gray-200">{description}</p>
        </motion.div>
    );
}