    ...
    return (
        <div ref={ref} className="flex flex-col items-center justify-center w-full py-10">
            ...
            >
                ...
                <motion.div
                    className="flex items-center justify-center w-32 h-32 px-3 py-3 rounded-full mx-auto bg-gradient-to-b from-gray-200 to-white"
                    animate={{ y: [0, -5, 0] }}
                ...
                <motion.div
                    ...
                    className="my-10"
                >
                    <h2 className="text-5xl font-bold bg-gradient-to-r from-black to-gray-300 bg-clip-text text-transparent animate-gradientMove">
                        Let’s Build a Website That
                    </h2>

                    <h2 className="text-5xl font-bold mt-6 bg-gradient-to-r from-black to-gray-300 bg-clip-text text-transparent animate-gradientMove">
                        Works for You
                    </h2>
                </motion.div>
            </motion.div>
